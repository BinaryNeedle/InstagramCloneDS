...
{{-- <section class="h-full dark:bg-[#111828]">
    <section class="flex py-3">
        <img class="w-10  rounded-full" src="{{ asset('assets/imgs/profiles/bjorka.png') }}" alt="">
        <p class="dark:text-white self-center ml-3 -mt-1"><a href="#"><b>Codio</a></b><span wire:poll.1s> •
                6 Year ago</span></p>
    </section>
    <section class="h-[700px] px-2 overflow-auto scrollbar-hide">
        <section class="flex flex-col py-3">
            <div class="flex mb-2">
                <img class="w-10 h-10 my-auto rounded-full" src="{{ asset('assets/imgs/profiles/bjorka.png') }}"
                    alt="">
    ...
    <section class="absolute inset-x-0 bottom-0 dark:bg-[#111828] pb-2 pt-1 border-t border-solid border-slate-200">
                ...
                <form action="POST" class="inline-block">
                    ...
                    <button name="like">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            class="bi bi-hand-thumbs-up inline-block" viewBox="0 0 16 16">
                            <path
