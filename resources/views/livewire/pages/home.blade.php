...
<section class="post-main mx-auto">
    ...
    <section class="w-full md:w-[470px] mx-0 md:mx-auto mb-3" @if ($loop->last) id="last_record" @endif>
        <section class="flex py-3">
            <img class="w-10  rounded-full" src="{{ asset('assets/imgs/profiles/' . $post->user->images) }}" alt="">
            <p class="dark:text-white self-center ml-3 -mt-1"><a href="#"><b>{{ $post->user->username }}</a></b><span wire:poll.1s> • {{ \Carbon\Carbon::parse($post->created_at)->diffForHumans() }}</span></p>
        </section>
        <section class="mb-3">
        ...
        <section class="flex dark:text-white justify-start mb-3">
            ...
            <span class="mx-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-share mt-1" viewBox="0 0 16 16">
                    <path d="M13.5 1a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zM11 2.5a2.5 2.5 0 1 1 .603 1.628l-6.718 3.12a2.499 2.499 0 0 1 0 1.504l6.718 3.12a2.5 2.5 0 1 1-.488.876l-6.718-3.12a2.5 2.5 0 1 1 0-3.256l6.718-3.12A2.5 2.5 0 0 1 11 2.5zm-8.5 4a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zm11 5.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z" />
                </svg>
            </span>
        </section>
        <p class="{{ $post->likes->count() == 0 ? 'hidden' : 'inline-block'}} dark:text-white" wire:poll.750ms>{{ $this->getLikeCountText($post) }}</p>
        <section class="mb-3">
            <p class="w-full resize-none bg-transparent focus:outline-none overflow-hidden max-h-32 dark:text-white text-justify scrollbar-hide" readonly>{{ $this->getCaption($post, false) }}</p>
            <a href="#" wire:click="setCaptionState($post)" class="dark:text-slate-400">more</a>
        </section>
        ...
        <section class="mt-2">
            <form action="POST">
                @csrf
                <div class="flex">
                    <input class="w-full dark:bg-transparent dark:text-white focus:outline-none border-b border-gray-200 border-solid pb-2" name="comment" type="text" placeholder="add a comment...">
