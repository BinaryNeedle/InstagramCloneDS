        ...
        <div class="dark:bg-[#1f2937] shadow-md rounded px-8 pt-6 pb-8">
            ...
            <form wire:submit="login">
                ...
                <div class="mb-4">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username_or_email" type="text" name="username_or_email" value="{{ old('username_or_email') }}" wire:model="username_or_email" required autofocus>
                ...
                <div class="mb-7 flex flex-col">
                    ...
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" name="password" wire:model="password" required>
                    <span id="shpw" class="-mt-8 mr-3 self-end">
                        <svg id="show" class="w-6 h-6 text-gray-800 dark:text-dark hover:cursor-pointer hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 14">
                            <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
                                <path d="M10 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
                                <path d="M10 13c4.97 0 9-2.686 9-6s-4.03-6-9-6-9 2.686-9 6 4.03 6 9 6Z" />
                            </g>
                        </svg>
                        <svg id="hide" class="w-6 h-6 text-gray-800 dark:text-dark hover:cursor-pointer" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
