                ...
                <form wire:submit="register">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="username" type="text"
                            ...
                            name="username" value="{{ old('username') }}" wire:model="username" required autocomplete="username" autofocus>
                        @error('username')
                    ...
                    <div class="mb-4">
                        ...
                        <input id="name" type="text"
                            ...
                            name="name" value="{{ old('name') }}" wire:model="name" required autocomplete="name" autofocus>
                        @error('name')
                            <p class="text-red-500 text-xs italic mt-4 pl-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-7 flex flex-col">
                        ...
                        <span id="show_confirmation" class="-mt-8 mr-3 self-end">
