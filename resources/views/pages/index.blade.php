        ...
        <section
            ...
            <section class="w-full flex flex-col justify-end dark:bg-[#111828]">
                <div class="h-32 xl:h-20 flex border-b border-gray-200 border-solid pl-5">
                    <img class="w-[60px] h-[60px] rounded-full my-auto" src="{{ URL::asset('assets/imgs/bjorka.png') }}"
                        alt="{{-- isi username / nama --}}">
                    <p class="dark:text-white my-auto ml-3 text-xl">Bjorka</p>
                </div>
                <div class="h-[20rem] xl:h-96">
                    <textarea
                        class="w-full h-full resize-none bg-transparent dark:text-white cursor-default focus:outline-none overflow-y-auto scroll-smooth"
                        type="text" readonly>asdfasdfasdf</textarea>
                </div>
