...
@section('content2')
    ...
    <section class="post-main mx-auto">
        <section class="w-full md:w-[470px] mx-0 md:mx-auto">
            <section class="flex py-3">
                <img src="{{ URL::asset('assets/imgs/logo_codio.png') }}" alt="">
                <p class="dark:text-white self-center ml-1"><span>@</span>Codio<span> | 2 d</span></p>
            </section>
            <section class="mb-3">
                <img src="https://s3.amazonaws.com/www-inside-design/uploads/2020/10/aspect-ratios-blogpost-1x1-1.png"
                    alt="">
            </section>
            <section class="flex dark:text-white justify-center mb-3">
                <span class="mx-2">
            ...
            <section class="mb-3">
                <textarea class="w-full resize-none bg-transparent focus:outline-none dark:text-white text-justify h-32 scrollbar-hide"
            ...
            <section>
                <form action="POST">
                    ...
                    <div class="flex">
                        <input
                            class="w-full dark:bg-transparent dark:text-white focus:outline-none border-b border-gray-200 border-solid"
