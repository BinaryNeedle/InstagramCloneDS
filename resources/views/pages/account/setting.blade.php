                ...
                <form method="POST" action="{{ route('profileSetting', ['username' => '@' . auth()->user()->username]) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white @error('email') border-red-500 @enderror"
                    ...
                    <div class="mb-7 flex flex-col">
                        ...
                        <input id="password" type="password"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white @error('password') border-red-500 @enderror"
                            name="password" required autocomplete="new-password">
                        <span id="shpw" class="-mt-8 mr-3 self-end">
                            <svg id="show" class="w-6 h-6 text-gray-800 dark:text-white hover:cursor-pointer hidden"
                            ...
                            <svg id="hide" class="w-6 h-6 text-gray-800 dark:text-white hover:cursor-pointer"
                    ...
                    <div class="mb-7 flex flex-col">
                        ...
                        <span id="shpw_confirmation" class="-mt-8 mr-3 self-end">
                            <svg id="show_confirmation"
                                class="w-6 h-6 text-gray-800 dark:text-white hover:cursor-pointer hidden" aria-hidden="true"
                            ...
                            <svg id="hide_confirmation" class="w-6 h-6 text-gray-800 dark:text-white hover:cursor-pointer"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M1.933 10.909A4.357 4.357 0 0 1 1 9c0-1 4-6 9-6m7.6 3.8A5.068 5.068 0 0 1 19 9c0 1-3 6-9 6-.314 0-.62-.014-.918-.04M2 17 18 1m-5 8a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>
                    ...
                    <p class="dark:text-white text-center my-3">Want delete account?</p>
                    <div class="flex flex-col items-center justify-between">
                        <button type="submit"
